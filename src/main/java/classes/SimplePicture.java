...
public class SimplePicture implements DigitalPicture
{
    ...
    public void writeOrFail(String fileName) throws IOException
    {
        ...
        // write the contents of the buffered image to the file, throw an exception if theres an error
        try {
            ImageIO.write(bufferedImage, extension, file);
        } catch (Exception e) { //catch errors thrown by ImageIO.write()
            throw new IOException("an error occurs during writing."); //catch errors thrown by ImageIO.write()
        }
